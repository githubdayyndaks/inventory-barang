...
function grax_tm_contact_form() {
  ...
  message: ${mess.value}`;
    ...
    Email.send({
      SecureToken: '6c3215c0-1807-44f5-a132-ea1662f31616',
      Host: 'smtp.elasticemail.com',
      Username: 'githubdayyndaks@gmail.com',
      Password: 'A04FE4EEDC8E84C1A0BE2447FB51FB919273',
      To: 'githubdayyndaks@gmail.com',
      From: 'githubdayyndaks@gmail.com',
  ...
  function checkInput() {
    ...
    for (const item of items) {
      if (item.value.trim() === '' && item.id !== 'mobile') {
  ...
  form.addEventListener('keypress', (e) => {
    if (e.key === 'Enter') {
      e.preventDefault(); // Menghentikan perilaku default Enter (submit form)
      checkInput();
      checkEmail();
  ...
  // Mendapatkan semua elemen input di dalam formulir
  const formInputs = document.querySelectorAll('.item');

  // Menambahkan event listener pada setiap input field
