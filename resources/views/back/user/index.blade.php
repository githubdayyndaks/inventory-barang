...
@section('title', Auth::user()->name . ' - User Inventory barang')
@section('content')
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <body class="loading" data-layout-color="light"  data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
                                ...
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <a href="users/create" class="btn btn-primary mb-2">
                                             <span class="icon"><i class="mdi mdi-pencil"></i></span> Tambah user</a>
                                        @endif
                                        ...
                                        <table id="responsive-datatable" class="table table-bordered table-bordered dt-responsive nowrap">
                                            ...
                                            <tr>
                                                ...
                                                <th>Email</th>
                                                <th>level</th>
                                                @if(App\Helpers\UserHelper::isAdmin(auth()->user()))
                                                <th>Function</th>
                                                @endif
                                            </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if (auth()->user()->level == 'admin')
                                                        <a href="{{url('users/'.$item->id_user.'/edit')}}" class="btn btn-warning mb-2">
                                                            <span class="icon"><i class="mdi mdi-pencil"></i></span> Edit</a>
                                                        @endif
                                                        @if (auth()->user()->level == 'admin')
                                                        <a href="#" onclick="deleteUser(this)" data-id="{{$item->id_user}}"  class="btn btn-danger mb-2">
                                                            <span class="icon"><i class="mdi mdi-trash-can"></i></span>Delete</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                @endforeach
       ...
       <script>
        ...
        console.log("ID User yang Dihapus:", id_user);
