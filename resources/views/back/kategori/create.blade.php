...
@section('title', Auth::user()->name . ' - Tambah Kategori')
@section('content')
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="card-body table-responsive">
                                       ...
                                       <div class="row">
                                        <div class=" mb-3 col-md-12">
                                            ...
                                            <?php
                                                $kodeRuangan = autonumber('kategori', 'kode_kategori', 3, 'KTG');
                                            ?>
                          <input class="input @error('kode_kategori') is-invalid @enderror form-control" name="kode_kategori" readonly id="kode_kategori" type="text" value="<?= $kodeRuangan ?>">
                                        ...
                                        <div class=" mb-3 col-md-12">
                                            ...
                                            id="nama_kategori" type="text" placeholder="Masukan Nama Kategori" value="{{old('nama_kategori')}}">
                                            @error('nama_kategori')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
