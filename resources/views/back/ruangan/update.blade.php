...
@section('title', Auth::user()->name . ' - Edit Ruangan')
@section('content')
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <form action="{{url('ruangan/'.$ruangan->kode_ruangan)}}" method="POST" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
                                       <div class="row">
                                        <div class=" mb-3 col-md-12">
                                            <label for="kode_ruangan">Kode ruangan</label>
                          <input class="input @error('kode_ruangan') is-invalid @enderror form-control" name="kode_ruangan" readonly id="kode_ruangan" type="text" 
                            value="{{old('kode_ruangan', $ruangan->kode_ruangan)}}">
                                        ...
                                        <div class=" mb-3 col-md-12">
                                            ...
                                            id="nama_ruangan" type="text" value="{{old('nama_ruangan', $ruangan->nama_ruangan)}}">
                                            @error('nama_ruangan')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
