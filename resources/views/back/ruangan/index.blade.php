...
<head>
    ...
    <body class="loading" data-layout-color="light"  data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <a href="{{url('ruangan/create')}}" class="btn btn-primary mb-2">
                                            <span class="icon"><i class="mdi mdi-pencil"></i></span> Tambah Ruangan</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if (auth()->user()->level == 'admin' || auth()->user()->level == 'petugas')
                                                        <a href="{{url('ruangan/'.$item->kode_ruangan.'/edit')}}" class="btn btn-warning mb-2">
                                                            <span class="icon"><i class="mdi mdi-pencil"></i></span> Edit Ruangan</a>
                                                        @endif
                                                        @if (auth()->user()->level == 'admin' || auth()->user()->level == 'petugas')
                                                            <a href="#" onclick="deleteRuangan(this)" data-id="{{$item->kode_ruangan}}"  class="btn btn-danger mb-2">
       ...
       <script>
        ...
        function deleteRuangan(e) {
        let id_ruangan = e.getAttribute('data-id');
        console.log("ID Ruangan yang Dihapus:", id_ruangan);
