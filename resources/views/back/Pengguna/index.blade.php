                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="widget-chart-1">
                                            <div class="widget-chart-box-1 float-start" dir="ltr">
                                                <span><i class="mdi mdi-account-group" style="font-size: 50px"></i></span>
                                            </div>
    
                                            <div class="widget-detail-1 text-end">
                                                <h2 class="fw-normal pt-2 mb-1"> {{$total_users}} </h2>
                                                <p class="text-muted mb-1">Users today</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title mt-0 mb-4">Total Data Barang</h4>
    
                                        <div class="widget-chart-1">
                                            <div class="widget-chart-box-1 float-start" dir="ltr">
                                                <span><i class="mdi mdi-file" style="font-size: 50px"></i></span>
                                            </div>
    
                                            <div class="widget-detail-1 text-end">
                                                <h2 class="fw-normal pt-2 mb-1"> {{$total_barang}} </h2>
                                                <p class="text-muted mb-1">Jumlah barang </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
