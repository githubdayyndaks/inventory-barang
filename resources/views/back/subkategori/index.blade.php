...
@section('title', Auth::user()->name . ' -  Subkategori')
@section('content')
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <body class="loading" data-layout-color="light"  data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
                                ...
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <p class="text-muted font-14 mb-3">
                                            Kelola Data SubKategori
                                        </p>
                                        
                                        <a href="{{url('subkategori/create')}}" class="btn btn-primary mb-2">
                                            <span class="icon"><i class="mdi mdi-pencil"></i></span> Tambah SubKategori</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if (auth()->user()->level == 'admin' || auth()->user()->level == 'petugas')
                                                        <a href="{{url('subkategori/'.$item->kode_subkategori.'/edit')}}" class="btn btn-warning mb-2">
                                                            <span class="icon"><i class="mdi mdi-pencil"></i></span> Edit</a>
                                                        @endif
                                                        @if (auth()->user()->level == 'admin' || auth()->user()->level == 'petugas')
                                                            <a href="#" onclick="deleteSubkategori(this)" data-id="{{$item->kode_subkategori}}"  class="btn btn-danger mb-2">
       ...
       <script>
        ...
        function deleteSubkategori(e) {
        let kode_subkategori = e.getAttribute('data-id');
        console.log("ID SubKategori yang Dihapus:", kode_subkategori);
    
        Swal.fire({
            title: 'Delete subkategori',
            text: "Are you sure?",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    type: 'DELETE',
                    url: '/subkategori/' + kode_subkategori,
                    dataType: "json",
