...
@section('title', Auth::user()->name . ' - Tambah Barang')
@section('content')
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="card-body table-responsive">
                                       ...
                                       <div class="row">
                                        <div class=" mb-3 col-md-12">
                                            ...
                                            <?php
                                                $kodebarang = autonumber('barang', 'kode_barang', 3, 'BRG');
                                            ?>
                              <input class="input @error('kode_barang') is-invalid @enderror form-control" name="kode_barang" readonly id="kode_barang" type="text" value="<?= $kodebarang ?>">
                                        ...
                                        <div class=" mb-3 col-md-12">
                                            <label for="nama_ruangan">Ruangan</label>
                                                    <select name="kode_ruangan" id="nama_ruangan" class="form-control">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="kode_subkategori" id="nama_subkategori" class="form-control">
                                                    ...
                                                    @foreach ($subkategori as $item)
                                                        <option value="{{$item->kode_subkategori}}" data-merk="{{$item->merk}}" data-jenis="{{$item->jenis}}">{{$item->nama_subkategori}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select name="kondisi" id="kondisi" class="form-control">
                                                    ...
                                                    <option value="perbaikan" @if(old('kondisi') == 'perbaikan') selected @endif>Sedang diperbaiki</option>
